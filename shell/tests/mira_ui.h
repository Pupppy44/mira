...
mira_ui_window_t mira_ui_create_window(const char* title, int width, int height) {
...
void mira_ui_display_window(mira_ui_window_t* window) {
...
void mira_ui_close_window(mira_ui_window_t* window) {
...
void mira_ui_draw_text(mira_ui_window_t* window, const char* text, int x, int y) {
...
void mira_ui_draw_pixel(mira_ui_window_t* window, int x, int y, uint32_t color) {
...
char mira_ui_get_input(mira_ui_window_t* window) {
